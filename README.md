# VectoRA — Build a Vector Database from Scratch in C++

![VectoRA Screenshot](screenshot.png)
...
```powershell
git clone https://github.com/Mohit/VectoRA.git
cd VectoRA
```
...
**Terminal 2** — Start the VectoRA server:
```powershell
./db
```
...
VectoRA            Unified interface over all 3 (16D demo vectors)
